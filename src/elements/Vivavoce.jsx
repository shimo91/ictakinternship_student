...
function Vivavoce() {
  ...
  const checkSubmission = async () => {
    try {
      const response = await axios.post('https://ictak-backend.onrender.com/getvivavoce', {email})
  ...
  const handleSubmission = async () => {
    try {
      if (docLink.trim() !== '' && reportName.trim() !== '') {
        const response = await axios.post('https://ictak-backend.onrender.com/googledoclinksubmit', { docLink, reportName, email });
